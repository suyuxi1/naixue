		...
		<view class="content">
			...
			<view class="entrance">
				<view class="item" @tap="takein">
					<image src="../../static/images/index/zq.png" class="icon" mode=""></image>
			...
			<view class="info">
				<view class="integral_section">
					<view class="top">
						...
						<text class="value">{{ isLogin ? userInfo.positNum : 0 }}</text>
					</view>
					<view class="bottom">
						进入积分商城兑换奈雪券及周边好礼
			...
			<view class="navigators">
				<view class="left">
					<view class="grid flex-column just-content-center">
						<view class="d-flex align-items-center">
							<image src="../../static/images/index/csc.png" class="mark-img" mode=""></image>
				...
				<view class="right">
					<view class="tea-activity">
						<image src="../../static/images/index/mcsb.png" class="mark-img" mode=""></image>
						<view>买茶送包</view>
						<view class="right-img"><image src="../../static/images/index/mcsb_bg.png" mode="widthFix"></image></view>
					</view>
					<view class="member-gifts">
						<image src="../../static/images/index/hyjb.png" class="mark-img" mode=""></image>
						<view>会员券包</view>
